...
class SQSHelper(AWSHelper):
    ...
    def send_message(self, queue_url: str, data: Dict[str, Any], delay_seconds: int = 0) -> Dict[str, Any]:
    ...
    def receive_messages(self, queue_url: str, max_messages: int = 10, wait_time_seconds: int = 20) -> List[Dict[str, Any]]:
...
class S3Helper(AWSHelper):
    ...
    def put_object(self, bucket: str, key: str, data: str, content_type: str = 'application/json') -> Dict[str, Any]:
        """Put an object to S3"""
        try:
...
class DynamoDBHelper(AWSHelper):
    ...
    def query(self, key_condition_expression: str, expression_values: Dict[str, Any], 
              scan_index_forward: bool = True, limit: int = None) -> List[Dict[str, Any]]:
    ...
    def scan(self, filter_expression: str = None, expression_values: Dict[str, Any] = None) -> List[Dict[str, Any]]:
